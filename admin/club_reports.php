...
if (match_referer() && isset($_POST['submit'])) {
        ...
        if ($errormsg){
             ...
             include($_SESSION["CFG"]["includedir"]."/errorpageBackToReports.php");
             include($_SESSION["CFG"]["includedir"]."/footer.php");
             die;
        }
        ...
        <td>
             ...
             <td valign="top">
                           ...
                           <table cellspacing="0" cellpadding="5" width="300">
                                  ...
                                  <tr class=clubid<?=get_clubid()?>th>
                                     <td></td>
                                     <td align="center"><font class="whitenormalsm">First Name</font></td>
                                     <td align="center"><font class="whitenormalsm">Last Name</font></td>
                                     <td align="center"><font class="whitenormalsm">Number of Reservations Made</font></td>
                                  </tr>
                                  <?
                                   ...
                                   $rc = (($i/2 - intval($i/2)) > .1) ? "C0C0C0" : "DBDDDD";
                                   ?>
                                   <tr bgcolor='<?=$rc?>' class='normal'>
                                   <td align="center"><?=$i?></td>
                                   <td align="center"><?=$vals['firstname']?></td>
                                   <td align="center\"><?=$vals['lastname']?></td>
...
function run_court_utilization_report(&$frm) {
		...
		for ($i=0; $i<30; $i++){
	        ...
	        while($courtArray = mysql_fetch_array($courtResult)){
				...
				$dailyCourtReservations = $dailyCourtReservations + $dailyCourtHours/($courtArray['courtid']); 
       ...
       //Reset the court results
        ...
        <td>
                  ...
                  <table cellspacing="0" cellpadding="5" width="440">
                         ...
                         <tr class=clubid<?=get_clubid()?>th>
                            <td><font class="whitenormalsm">Court Name</font></td>
                            <td><font class="whitenormalsm">Court Utilization %</font></td>
                            <td><font class="whitenormalsm">Number of Reservations Made</font></td>
                         </tr>
                         <?
                          $i=1;
                          arsort($dataArray);
