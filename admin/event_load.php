...
function add_events(&$frm) {
    ...
    // This is a reoccuring reservation
        ...
        if ($frm['repeat'] == "daily") {
            ...
            if ($frm['reoccurringduration'] == "week") $numdays = 7;
            
            if ($frm['reoccurringduration'] == "month") $numdays = 30;
            
            if ($frm['reoccurringduration'] == "year") $numdays = 365;
            
            if ($frm['reoccurringduration'] == "twodays") $numdays = 2;
            
            if ($frm['reoccurringduration'] == "threedays") $numdays = 3;
            
            if ($frm['reoccurringduration'] == "fourdays") $numdays = 4;
            
            if ($frm['reoccurringduration'] == "fivedays") $numdays = 5;
            
            if ($frm['reoccurringduration'] == "sixdays") $numdays = 6;
            for ($i = 0; $i < $numdays; $i++) {
                $startTime = gmmktime(gmdate("H", $initialStartTime) , gmdate("i", $initialStartTime) , gmdate("s", $initialStartTime) , gmdate("n", $initialStartTime) , gmdate("j", $initialStartTime) + $i, gmdate("Y", $initialStartTime));
                $endTime = gmmktime(gmdate("H", $initialEndTime) , gmdate("i", $initialEndTime) , gmdate("s", $initialEndTime) , gmdate("n", $initialEndTime) , gmdate("j", $initialEndTime) + $i, gmdate("Y", $initialEndTime));
        ...
        elseif ($frm['repeat'] == "biweekly") {
            ...
            if ($frm['reoccurringduration'] == "month") $numdays = 28;
        ...
        elseif ($frm['repeat'] == "monthly") {
            ...
            if ($frm['reoccurringduration'] == "week") $numdays = 1;
            
            if ($frm['reoccurringduration'] == "month") $numdays = 1;
            
            if ($frm['reoccurringduration'] == "year") $numdays = 12;
            for ($i = 0; $i < $numdays; $i++) {
                $startTime = gmmktime(gmdate("H", $initialStartTime) , gmdate("i", $initialStartTime) , gmdate("s", $initialStartTime) , gmdate("n", $initialStartTime) + $i, gmdate("j", $initialStartTime) + $i, gmdate("Y", $initialStartTime));
                $endTime = gmmktime(gmdate("H", $initialEndTime) , gmdate("i", $initialEndTime) , gmdate("s", $initialEndTime) , gmdate("n", $initialEndTime) + $i, gmdate("j", $initialEndTime) + $i, gmdate("Y", $initialEndTime));
...
function cancelReservation($time, $courtId) {
    ...
    if ($reservationArray['usertype'] == 1) {
