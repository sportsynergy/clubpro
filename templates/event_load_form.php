 ...
 * $LastChangedDate: 2008-09-24 19:35:17 -0700 (Wed, 24 Sep 2008) $
...
<table cellspacing="0" cellpadding="0" width="550" >
 <tr>
    <td class=clubid<?=get_clubid()?>th height=60><font class=whiteh1><div align="center">Event Reservation</div></font></td>
 </tr>
 ...
 <tr>
    <td class=generictable>
     ...
     <table cellspacing="10" cellpadding="0" width="500">
        ...
        <tr>
            <td class="label"><font color="Red" class="normalsm">* </font>Event:</td>
       ...
       <tr>
       		<td class="label"><font color="Red" class="normalsm">*</font> First Reservation:</td>
       		<td>
       ...
       <tr>
       		<td class="label"><font color="Red" class="normalsm">* </font>Last Reservation:</td>
       		<td>
       			<select name="endtime">
       				<option value="">Select Option</option>
       				<option value="">----------------------------</option>
       ...
       <tr>
       	...
       	and Duration for 'For A Month'. And so on.<br/><br/>
       	</td>
       </tr>
       <tr>
       		<td colspan="2" class="normal">
       			<input type="checkbox" name="cancelconflicts"> <i>Remove any existing reservations. By leaving this checkbox unchecked any
       			reservations that were already out there will be left alone.</i><br/><br/>
       		</td>
       		
       </tr>
       <tr>
            <td colspan="2"><font color="Red" class="normalsm">*</font><font class="normalsm">indicates a required field.</font><br/>
            <br/>
            </td>
        </tr>
       <tr>
...
echo "<input type=\"hidden\" name=\"courtduration\" value=\"$courtduration\">";
echo "<input type=\"hidden\" name=\"courtid\" value=\"$courtid\">";
