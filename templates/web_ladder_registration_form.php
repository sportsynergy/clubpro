 ...
 <tr>
    <td class="generictable">
     ...
     <?
       ...
       echo "<tr>\n";
       echo "<td colspan=5><font class=\"smallbold\">Box League Name</font></td>\n";
       ...
       while($row = mysql_fetch_row($result)) {  ?>
            ...
            <form name="removeWebLadder<?=$rowcount?>" method="post" action="<?=$ME?>">
              ...
              <td><a href="javascript:submitForm('removeWebLadder<?=$rowcount?>')"><font class="normalsm">Remove</font></a></td>
              <td><a href="javascript:submitForm('manageWebLadder<?=$rowcount?>')"><font class="normalsm">Manage</font></a></td>
               <td><a href="javascript:submitForm('moveupWebLadder<?=$rowcount?>')"><font class="normalsm">Move Up</font></a></td>
            </tr>
        ...
        if ($numrows==0){
           echo "<tr>\n";
           echo "<td colspan=6><font class=\"normalsm\">There are currently no box leagues configured.</font></td>";
           echo "</tr>\n";
        }
