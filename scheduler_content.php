...
?>
        ...
        <tr>
								...
								<form name="entryform" method="post" action="<?=$MEWQ?>">
			                              ...
			                              echo "<option value=$todaycounter selected>". gmdate(" l F j",$todaycounter) . "</option>";
			                               ...
			                               if(get_roleid()==2 && get_clubid()==$clubobj->clubid){
			                                   ...
			                                   // Set the Days Ahead
			                                   for ( $days = 0; $days < 2*(get_daysahead()); $days++){
			                                   echo "<option value=$todaycounter >". gmdate(" l F j",$todaycounter) . "</option>";
			                                   $todaycounter = $todaycounter+86400;
			                                   }
			                                }
 		...
 		<?
	 		//If there is even one grouping configured use it instead of the arrows.
		 				...
		 				<table cellspacing="0" cellpadding="0" border="0"  width="710">
							 ...
							 function submitCourtGroupForm(action, groupid)
							{
						        ...
						        document.courtGroupForm.submit();
					 			...
					 			<form name="courtGroupForm" method="post"><input type="hidden" name="courtGroupFromForm"><input type="hidden" name="daysahead" value="<?=$daysahead?>"></form>
			...
			<? 
			//Otherwise use the navigation arrows
			}else{ ?>
		 		...
		 		<tr>
		 			<td>
		 				<table cellspacing="0" cellpadding="0" border="0"  width="710">
							<tr height="15">
								<td align="left" > <? printLeftCourtNavigationArrow($totalCourts, $totalCourtResult, $currentCourtResult, $totalCurrentCourts, $daysahead); ?> <br></td>
								<td align="right" > <? printRightCourtNavigationArrow($totalCourts, $totalCourtResult, $currentCourtResult, $totalCurrentCourts, $daysahead); ?> <br></td>
              ...
              <table cellspacing="0" cellpadding="0" border="0"  width="710">
				...
				$courtWidth = getCourtTableWidth($totalCurrentCourts);
                 ...
                 while ($courtobj = db_fetch_object($currentCourtResult)) {
                  ...
                  echo "<td >";
                  echo "<table width=$courtWidth border=\"1\" cellpadding=\"0\" cellspacing=\"0\" bordercolor=\"Gray\" align=\"center\">\n";
                  echo "<tr valign=\"top\">\n";
                  echo "<th class=\"ct".$ctobj->courttypeid."cl".$clubobj->clubid."\">$ctobj->courttypename</th>\n";
                  echo "</tr>";
                  echo "<tr>\n";
 ...
 */
function printLeftCourtNavigationArrow($totalCourts, $totalCourtResult, $currentCourtResult, $totalCurrentCourts,$daysahead){
 ...
 */
function printRightCourtNavigationArrow($totalCourts, $totalCourtResult, $currentCourtResult, $totalCurrentCourts, $daysahead){
