  ...
  $numrows = mysql_num_rows($courtdetailsresult);
   ...
   if ($numrows==1){
                            ...
                            while($courtdetailsrow = db_fetch_row($courtdetailsresult)) {
                                ...
                                echo "<td width=\"30\"></td>\n";
                                echo "<td>\n";
                                echo "<font class=normalsm><a href=\"$wwwroot/users/court_cancelation.php?time=$courtdetailsrow[0]&courtid=$courtdetailsrow[4]\">".gmdate(" l F j h:i a",$courtdetailsrow[0])."</a> $courtdetailsrow[1] $courtdetailsrow[2] and ";
            ...
            if ($numrows!=2){
                 ...
                 if ((mysql_result($ddetailsresult,0,3))==0 && (mysql_result($ddetailsresult,2,3))==0){
                    ...
                    while($ddetailsrow = db_fetch_row($ddetailsresult)) {
                           ...
                           echo "<td width=\"30\"></td>\n";
                           echo "<td>\n";
                           echo "<font class=normalsm><a href=\"$wwwroot/users/court_cancelation.php?time=$ddetailsrow[4]&courtid=$ddetailsrow[6]\">".gmdate(" l F j h:i a",$ddetailsrow[4])."</a> $ddetailsrow[1] $ddetailsrow[2] and ";
           ...
           if ((mysql_result($courtdetailsresult,0,4))==0 && (mysql_result($courtdetailsresult,1,4))==0){
            ...
            $int = mysql_data_seek($courtdetailsresult,0);
                ...
                while($courtdetailsrow = db_fetch_row($courtdetailsresult)) {
                    echo "<tr>\n";
                    echo "<td width=\"30\"></td>\n";
                    echo "<td>\n";                    echo "<font class=normalsm>".gmdate(" l F j h:i a",$courtdetailsrow[0])."</a> $courtdetailsrow[1] $courtdetailsrow[2] and ";
                     $courtdetailsrow = db_fetch_row($courtdetailsresult);
                     echo "$courtdetailsrow[1] $courtdetailsrow[2] on $courtdetailsrow[3]</font>";
            ...
            if ($numrows!=2){
                 ...
                 if ((mysql_result($ddetailsresult,0,3))==0 && (mysql_result($ddetailsresult,2,3))==0){
                    ...
                    while($ddetailsrow = db_fetch_row($ddetailsresult)) {
                           ...
                           echo "<td width=\"30\"></td>\n";
                           echo "<td>\n";
                           echo "<font class=normalsm><a href=\"$wwwroot/users/report_scores.php?reservationid=$reservationID\">".gmdate(" l F j h:i a",$ddetailsrow[4])."</a> $ddetailsrow[1] $ddetailsrow[2] and ";
                           $ddetailsrow = db_fetch_row($ddetailsresult);
                           echo "$ddetailsrow[1] $ddetailsrow[2]";
                           $ddetailsrow = db_fetch_row($ddetailsresult);
                           echo " vs. ";
