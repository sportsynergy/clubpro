                 ...
                 $scourtdetailsresult = db_query($scourtdetailsquery);
                     ...
                     //Print out details on the singles reservations
                                 while($scourtdetailsrow = db_fetch_row($scourtdetailsresult)) {
                                     ...
                                     echo "<td width=\"30\"></td>\n";
                                     echo "<td>\n";
                                     echo "<font class=normalsm><a href=\"$wwwroot/users/court_reservation.php?time=$scourtdetailsrow[0]&courtid=$scourtdetailsrow[4]&userid=$scourtdetailsrow[7]\">".gmdate(" l F j h:i A",$scourtdetailsrow[0])."</a> $scourtdetailsrow[1] $scourtdetailsrow[2]  (rank $scourtdetailsrow[5]) on $scourtdetailsrow[3] ";
...
<?
 ...
 <?
  ...
  for($i=0; $i<count($doublesArray); $i++){
              ...
              if( $needTwoPlayer ){
              	 echo "<font class=normalsm><a href=\"$wwwroot/users/court_reservation.php?time=$playerOneArray[time]&courtid=$playerOneArray[courtid]&userid=$lonelyuserid\">".gmdate(" l F j h:i A",$playerOneArray['time'])."</a> $user1Name and $user2Name are both looking for a partner. ";
				
              }
              elseif( $needThreePlayer ){
              	 echo "<font class=normalsm><a href=\"$wwwroot/users/court_reservation.php?time=$playerOneArray[time]&courtid=$playerOneArray[courtid]&userid=$lonelyuserid\">".gmdate(" l F j h:i A",$playerOneArray['time'])."</a> $reallyLonelyuser is looking for some doubles squash. ";
              ...
              $teamRankValue = mysql_result($teamRankResult,0);
                 ...
                 echo "<font class=normalsm><a href=\"$wwwroot/users/court_reservation.php?time=$playerOneArray[time]&courtid=$playerOneArray[courtid]&userid=$lonelyuserid\">".gmdate(" l F j h:i A",$playerOneArray['time'])."</a> $lonelyuser needs a partner to play against $teamnamesrow[0] $teamnamesrow[1] and ";
				 //Get the next player
                 $teamnamesrow = db_fetch_row($teamnamesresult);
              ...
              $teamRankValue = mysql_result($teamRankResult,0);
                   ...
                   echo "<font class=normalsm><a href=\"$wwwroot/users/court_reservation.php?time=$playerTwoArray[time]&courtid=$playerTwoArray[courtid]&userid=$playerTwoArray[userid]\">".gmdate(" l F j h:i A",$playerTwoArray['time'])."</a> $teamnamesrow[0] $teamnamesrow[1] and ";
                  //Get the next player
                  $teamnamesrow = db_fetch_row($teamnamesresult);
                  echo "$teamnamesrow[0] $teamnamesrow[1]";
                 ...
                 $scourtdetailsresult = db_query($scourtdetailsquery);
                     ...
                     //Print out details on the singles reservations
                             while($scourtdetailsrow = db_fetch_row($scourtdetailsresult)) {
                               ...
                               echo "<td width=\"30\"></td>\n";
                               echo "<td>\n";
                               echo "<font class=normalsm><a href=\"$wwwroot/users/court_reservation.php?time=$scourtdetailsrow[0]&courtid=$scourtdetailsrow[4]\">".gmdate(" l F j h:i A",$scourtdetailsrow[0])."</a> $scourtdetailsrow[1] $scourtdetailsrow[2] on $scourtdetailsrow[3] ";
                                if($scourtdetailsrow[6]==1){
                                    echo "<img src=\"$imagedir\boxleague.gif\">";
                                 }
                               echo "</td>\n";
