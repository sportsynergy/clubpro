create table clubpro_main.tblClubEvents
(
    id               int auto_increment
        primary key,
    name             varchar(45) charset utf8 charset utf8 default '' not null,
    clubid           int             default 0                 not null,
    eventdate        date            default '0000-00-00'      not null,
    eventenddate     date            default '0000-00-00'      null,
    description      text charset utf8 charset utf8 not null,
...
create index clubid
    on clubpro_main.tblClubEvents (clubid);
